                ...
                for(let i=0;i<data.page.content.length;i++){
                    if (me==0){
                        $(".filtr-container").append('<div class="filtr-item chunk" fileid='+data.page.content[i].id+'>\n' +
                            ...
                            '<div class="susdiv">\n' +
                            '<div class="operation download"><i class="my-icon lsm-sidebar-icon icon-chazhao querybtn"></i></div>\n' +
                            '<div class="operation compile"><i class="my-icon lsm-sidebar-icon icon-chazhao querybtn"></i></div>\n' +
                            '<div class="operation delete"><i class="my-icon lsm-sidebar-icon icon-chazhao querybtn"></i></div>\n' +
                            '</div>\n' +
                            '</div>');
                    }else{
